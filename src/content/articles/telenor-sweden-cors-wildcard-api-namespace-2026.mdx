...
description: "SecurityClaw found ACAO: * on every path under /api/* at www.telenor.se, a Spring Boot health actuator exposed on api-app.telenor.se, and missing HSTS on Ownit. Here's what the scan turned up across Telenor's YesWeHack program."
date: 2026-06-23
category: research
