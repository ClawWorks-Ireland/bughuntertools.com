...
Once you have a list of live subdomains, check them for takeover opportunities — the [subdomain takeover guide for EU bounty targets](/articles/subdomain-takeover-eu-bounty-targets-2026/) covers which services are exploitable and what programs pay for them. If you're setting up a repeatable recon environment, the [security lab setup guide](/articles/security-lab-setup-guide-2026/) has recommendations for organizing your tooling.
