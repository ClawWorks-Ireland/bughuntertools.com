...
description: "SecurityClaw ran 16 AI skills against bol.com on EC2 and recovered 2,607 findings. Here's what they mean for bug bounty recon at scale."
date: 2026-04-30
category: research
...
Campaign-006 is scoped to dig into those questions. The platform is ready. If you're hunting subdomain-related findings on mature targets, see the [bol.com subdomain recon walkthrough](/articles/securityclaw-bol-subdomain-recon-staging-demo-2026/) for a deeper look at what CT log enumeration surfaces.
...
- `hipstershop.stg.bol.com` — Google microservices demo app on staging environment (see [Campaign-004](/articles/securityclaw-campaign-004-bol-ec2-run-2026/) for detail)
