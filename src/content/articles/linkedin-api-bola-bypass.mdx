...
<article>
            ...
            <section id="how-to-test">
                ...
                <ul>
                    ...
                    <li><strong>GraphQL queries:</strong> { post(id: "12345") { content } }</li>
                </ul>
                ...
                <ul>
                    <li><strong>Query for restricted fields:</strong> { user { premiumFeature } }</li>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "headline": "LinkedIn API Access Control Bypass - BOLA Testing Guide for Bug Hunters",
      "description": "LinkedIn API access control bypass discovered. Learn BOLA/IDOR testing techniques for GraphQL APIs and premium feature enumeration.",
      "author": {
        "@type": "Organization",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is BOLA and why does it matter for bug bounties?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "BOLA is the #1 API security vulnerability. It's common (40%+ of APIs affected) and high-value ($500-5,000 bounties typical). APIs don't verify if user has permission to access specific resources."
          }
        },
        {
          "@type": "Question",
          "name": "How do I test for BOLA vulnerabilities?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Create two accounts. Have User A create a resource. Capture API request. Change to User B's session but keep User A's resource ID. If User B can access → BOLA vulnerability."
          }
        },
        {
          "@type": "Question",
          "name": "What tools do I need for BOLA/IDOR testing?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Burp Suite Professional is essential - use Autorize extension for automated testing. Postman for GraphQL. Two browser profiles for separate sessions. Budget: $449/year for Burp Pro."
          }
        },
        {
          "@type": "Question",
          "name": "How much do BOLA vulnerabilities typically pay?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Low: $100-500. Medium: $500-2,000. High: $2,000-10,000. Critical: $10,000-50,000+. LinkedIn average: $2,500-5,000 for BOLA/IDOR."
          }
        },
        {
          "@type": "Question",
          "name": "What's the difference between BOLA and IDOR?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Same vulnerability, different names. IDOR is old OWASP term. BOLA is new API Security term. Modern programs use BOLA. Both mean: unauthorized resource access."
          }
        },
        {
          "@type": "Question",
          "name": "Are GraphQL APIs more vulnerable to BOLA?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. GraphQL's flexibility makes authorization complex. Single endpoint, multiple resource types. Field-level authorization is harder to maintain. Introspection exposes schema."
          }
        },
        {
          "@type": "Question",
          "name": "What should I do after finding a BOLA vulnerability?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Document: endpoint, resource, bypass method. Proof: screenshots. Impact: scope of affected users. Suggest remediation. Report via bug bounty platform. Don't exploit beyond PoC."
          }
        },
        {
          "@type": "Question",
          "name": "Can I test LinkedIn for BOLA vulnerabilities?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes - active HackerOne program. But high competition. Better ROI: test smaller programs with newer APIs, GraphQL, or recently launched features."
          }
        }
      ]
    },
    {
      ...
      "description": "Industry-standard tool for API security testing. Essential for BOLA/IDOR testing with Autorize extension.",
      "category": "Software",
      "offers": {
        "@type": "Offer",
        "price": "449.00",
    ...
    },
    {
      ...
      "description": "Essential guide covering BOLA/IDOR testing, authorization bypass techniques, and API security fundamentals.",
