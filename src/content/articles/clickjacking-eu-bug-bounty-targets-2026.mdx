...
|-------|----------|---------|
| `cas.tomorrowland.com` | MEDIUM (CVSS 4.3) | X-Frame-Options missing, CSP missing — SSO portal fully embeddable |
...
The SSO scope makes this a MEDIUM rather than a LOW. Compromising a `cas.tomorrowland.com` session means access to everything connected to that account, not just one service. CVSS 4.3: `AV:N/AC:L/PR:N/UI:R/S:U/C:L/I:L/A:N`.
